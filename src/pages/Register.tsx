                ...
                <div className="ion-content-centered">
                    <div>
                        ...
                        <form action="" onSubmit={doLogin} style={{marginTop: '43px'}}>
                            ...
                            <input className='inter-black-thin-12 loginInput' type="text" placeholder='Peter Parker'/>
                            ...
                            <div className='checkbox-login-container'>
                                <div className='checkbox-login'>
                                    ...
                                    <p className='inter-black-thin-12'>Eu concordo com os <span className='detail'>Termos & Condições</span> e a <span className='detail'>Política de <br></br>Privacidade</span></p>
                                </div>
                            </div>

                            <IonButton className='login-button' type='submit' expand='block'>Register</IonButton>
                        </form>
